...
Minified just 284 Bytes!!! (This README has 824 Bytes)
...
- For events use standard-attributes e.g. "onclick", "oninput".
  ...
  If you prefer to put the JS-Code into seperate files use it like this: "data-bind='variable, value' data-set='yourFunction(argument)'"
